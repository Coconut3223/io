...
.. danger:: node 安装
    ...
    | `解决-安装node.js后，使用npm命令时报没有权限的错误Error`_.
...
.. _解决-安装node.js后，使用npm命令时报没有权限的错误Error: EACCES: permission denied: https://blog.csdn.net/HuangLin_Developer/article/details/80050981